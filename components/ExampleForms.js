const exampleForm = {
    template: `
        <form action="#" method="post" @submit.prevent="saveData">
                ...
                <label for="">
                    Sexo:
                    <select name="sexo" v-model="sexo" id="">
                ...
                <label for="">
                    Descrição:
                    <textarea v-model="description" name="description" placeholder="Descrição" id=""></textarea>
                </label>
                <label for="">
    ...
    methods: {
        saveData () {
            this.reset()
            if (this.name === '') {
                this.errors.name = 'Informe um valor para nome'
